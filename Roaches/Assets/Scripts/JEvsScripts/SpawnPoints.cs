...
public class SpawnPoints : MonoBehaviour
{
   ...
   // HumanProto hPlayer;
    ...
    void Start()
    {
        ...
        // gross as I am clearing then populating the spawnPoints again, but needed to have full list for respawns - TIME CONSTRAINTS hahah
        cockRoachSpawnPoints.Clear();
    ...
    public void SetPlayerAtSpawnPos(Transform roach)
    {
        // respawn function
        int randSpawnPoint = Random.Range(0, cockRoachSpawnPoints.Count);

        roach.position = cockRoachSpawnPoints[randSpawnPoint].position;
